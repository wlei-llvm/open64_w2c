...
#ifdef W2C
/* add by mw, convert =m output constrain into input constrain,
 * we should remove the '=' to make whirl2c happy. eon bug17
 */
char *Remove_Equal_Op(char *str) {
			 ...
			 int   line)
{
  ...
  for (tail = outputs;
	...
	FmtAssert(addr_of_lvalue != NULL,
        ...
        // add by mw, convert =m output constrain into input constrain,
        // we should remove the '=' to make whirl2c happy. eon bug17    
       constraint_string=Remove_Equal_Op(constraint_string);
#endif
