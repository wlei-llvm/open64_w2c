...
#define STATUS_NEEDS_ADDR       0x000000008
                                  /* Needs to add '&' */
#define STATUS_NO_DIRECT_CAST      0x000000010
                                  /* not to add '&' when type cast */
#define STATUS_NEEDS_REF        0x000000020
                                  /* Needs to add '*' */
#define STATUS_NEEDS_POINT      0x000000040
                                  /* Needs '->' or '.' to refer a field  */
...
#define STATUS_needs_addr(s) ((s) & STATUS_NEEDS_ADDR)
#define STATUS_set_needs_addr(s) ((s) = (s) | STATUS_NEEDS_ADDR)
#define STATUS_reset_needs_addr(s) ((s) = (s) & ~STATUS_NEEDS_ADDR)

#define STATUS_needs_ref(s) ((s) & STATUS_NEEDS_REF)
#define STATUS_set_needs_ref(s) ((s) = (s) | STATUS_NEEDS_REF)
#define STATUS_reset_needs_ref(s) ((s) = (s) & ~STATUS_NEEDS_REF)

#define STATUS_no_direct_cast(s) ((s) & STATUS_NO_DIRECT_CAST)
#define STATUS_set_no_direct_cast(s) ((s) = (s) | STATUS_NO_DIRECT_CAST)
#define STATUS_reset_no_direct_cast(s) ((s) = (s) & ~STATUS_NO_DIRECT_CAST)

#define STATUS_needs_point(s) ((s) & STATUS_NEEDS_POINT)
#define STATUS_set_needs_point(s) ((s) = (s) | STATUS_NEEDS_POINT)
#define STATUS_reset_needs_point(s) ((s) = (s) & ~STATUS_NEEDS_POINT)
