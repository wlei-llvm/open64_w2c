...
#ifdef W2C
extern void Set_TY_needs_no_ty_decl(const TY_IDX ty);
extern void Reset_TY_needs_no_ty_decl(const TY_IDX ty);
extern BOOL TY_needs_no_ty_decl(const TY_IDX ty);
#endif
