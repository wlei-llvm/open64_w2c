			 ...
			 simpnode k0, simpnode k1, BOOL k0const, BOOL k1const)
{
   ...
   if ((k1const && 
       SIMP_IS_TYPE_INTEGRAL(ty) &&  // KEY: Bug 12430
       SIMP_TYPE_SIZE(ty)==32&&
	 SIMP_Is_Int_Constant(k1) && SIMP_Int_ConstVal(k1)==-2147483648) ||
	 (k1const && 
       SIMP_IS_TYPE_INTEGRAL(ty) &&  // KEY: Bug 12430
       SIMP_TYPE_SIZE(ty)==64&&
	 SIMP_Is_Int_Constant(k1) && SIMP_Int_ConstVal(k1)==-9223372036854775808))
   	{}
	 else
#endif
