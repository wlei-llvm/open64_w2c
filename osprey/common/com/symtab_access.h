...
#ifdef W2C
inline BOOL
ST_cvt_static_to_extern (const ST& s)		{ return s.flags_ext & ST_CVT_STATIC_TO_EXTERN;}
inline void
Set_st_cvt_static_to_extern (ST& s)		{ s.flags_ext |= ST_CVT_STATIC_TO_EXTERN; }
inline void
Clear_st_cvt_static_to_extern (ST& s)		{ s.flags_ext &= ~ST_CVT_STATIC_TO_EXTERN; }
#endif
