...
CLIST_FLAGS Clist_Flags =
{
   ...
   0,     /* line_length */
   #ifdef W2C
    FALSE,  /*process symtab.w2c.c  .h */
   FALSE,  /* whirl/symtab normalize */ 
   #else
...
#ifdef W2C       
  { OVK_NAME,	OV_INTERNAL,	        FALSE, "emit_gsymtab",       NULL,
       0, 0, 0, &CLF.emit_gsymtab, NULL,
       "switch to control whether to emit gsymtab to w2c/w2h"},
  { OVK_NAME,	OV_INTERNAL,	        FALSE, "normalize",       NULL,
       0, 0, 0, &CLF.normalize, NULL,
       "whirl/symtab normalize"},
#endif       
