...
#ifdef W2C   
   /*added by wy*/
   BOOL       emit_gsymtab;     /*process symtab.w2c.c  .h */
   BOOL       normalize;        /* whirl/symtab normalize */
#endif   
...
#ifdef W2C
//added by wy
#define CLIST_emit_gsymtab     Current_CLIST->emit_gsymtab
//add by mw
#define CLIST_normalize     Current_CLIST->normalize
#endif
