...
#ifdef PACE
/* ===== Feature enable flags: ===== */
extern BOOL IPA_Enable_Normal;    /* enable normal IPA*/
extern BOOL IPA_Enable_AGGR;      /* enable aggressive IPA*/
extern BOOL IPA_Enable_Slicing;	/* enable IPA scc slicing */
#endif
...
#ifdef W2C
extern BOOL IPA_Enable_Align_Analysis ; /*enable ipa align analysis*/                                         // cmchen 08-3-4
extern BOOL IPA_Enable_Allocate_Simplify ; /* enable F90 allocate array simplification */                // cmchen 08-3-4
#endif
#ifdef KEY
typedef enum
{
