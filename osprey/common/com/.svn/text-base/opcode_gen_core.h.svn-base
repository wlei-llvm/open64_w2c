...
#ifdef TARG_NVISA
#define INT_MADD_OPCODES	// integer madds
#define FLOAT_ROUNDING_OPCODES	// fp->fp rounding 
#endif
...
typedef enum {
  ...
  OPC_M8I1ADD            = OPR_ADD + RTYPE(MTYPE_M8I1) + DESC(MTYPE_V),
  OPC_M8I2ADD            = OPR_ADD + RTYPE(MTYPE_M8I2) + DESC(MTYPE_V),
  OPC_M8I4ADD            = OPR_ADD + RTYPE(MTYPE_M8I4) + DESC(MTYPE_V),
  OPC_M8F4ADD            = OPR_ADD + RTYPE(MTYPE_M8F4) + DESC(MTYPE_V),
#endif /* TARG_X8664 */
  ...
  OPC_F4F4CEIL           = OPR_CEIL + RTYPE(MTYPE_F4) + DESC(MTYPE_F4),
  OPC_F8F8CEIL           = OPR_CEIL + RTYPE(MTYPE_F8) + DESC(MTYPE_F8),
#endif
#ifndef TARG_X8664
...
#else
  OPC_V8I1CONST          = OPR_CONST + RTYPE(MTYPE_V8I1) + DESC(MTYPE_V),
  OPC_V8I2CONST          = OPR_CONST + RTYPE(MTYPE_V8I2) + DESC(MTYPE_V),
  OPC_V8I4CONST          = OPR_CONST + RTYPE(MTYPE_V8I4) + DESC(MTYPE_V),
  OPC_M8I1CONST          = OPR_CONST + RTYPE(MTYPE_M8I1) + DESC(MTYPE_V),
  OPC_M8I2CONST          = OPR_CONST + RTYPE(MTYPE_M8I2) + DESC(MTYPE_V),
  OPC_M8I4CONST          = OPR_CONST + RTYPE(MTYPE_M8I4) + DESC(MTYPE_V),
...
#ifdef KEY
OPC_FQFQFLOOR        = OPR_FLOOR + RTYPE(MTYPE_FQ) + DESC(MTYPE_FQ),
  ...
  OPC_I4MADD             = OPR_MADD + RTYPE(MTYPE_I4) + DESC(MTYPE_V),
  OPC_I8MADD             = OPR_MADD + RTYPE(MTYPE_I8) + DESC(MTYPE_V),
  OPC_U4MADD             = OPR_MADD + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  OPC_U8MADD             = OPR_MADD + RTYPE(MTYPE_U8) + DESC(MTYPE_V),
#endif
...
#ifdef INT_MADD_OPCODES
  OPC_I4MSUB             = OPR_MSUB + RTYPE(MTYPE_I4) + DESC(MTYPE_V),
  OPC_I8MSUB             = OPR_MSUB + RTYPE(MTYPE_I8) + DESC(MTYPE_V),
  OPC_U4MSUB             = OPR_MSUB + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  OPC_U8MSUB             = OPR_MSUB + RTYPE(MTYPE_U8) + DESC(MTYPE_V),
#endif
...
#ifdef INT_MADD_OPCODES
  OPC_I4NMADD             = OPR_NMADD + RTYPE(MTYPE_I4) + DESC(MTYPE_V),
  OPC_I8NMADD             = OPR_NMADD + RTYPE(MTYPE_I8) + DESC(MTYPE_V),
  OPC_U4NMADD             = OPR_NMADD + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  OPC_U8NMADD             = OPR_NMADD + RTYPE(MTYPE_U8) + DESC(MTYPE_V),
#endif
...
#ifdef INT_MADD_OPCODES
  OPC_I4NMSUB             = OPR_NMSUB + RTYPE(MTYPE_I4) + DESC(MTYPE_V),
  OPC_I8NMSUB             = OPR_NMSUB + RTYPE(MTYPE_I8) + DESC(MTYPE_V),
  OPC_U4NMSUB             = OPR_NMSUB + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  OPC_U8NMSUB             = OPR_NMSUB + RTYPE(MTYPE_U8) + DESC(MTYPE_V),
#endif
  ...
  OPC_V8I1SUB            = OPR_SUB + RTYPE(MTYPE_V8I1) + DESC(MTYPE_V),
  OPC_V8I2SUB            = OPR_SUB + RTYPE(MTYPE_V8I2) + DESC(MTYPE_V),
  OPC_V8I4SUB            = OPR_SUB + RTYPE(MTYPE_V8I4) + DESC(MTYPE_V),
  OPC_V8F4SUB            = OPR_SUB + RTYPE(MTYPE_V8F4) + DESC(MTYPE_V),
  OPC_M8I1SUB            = OPR_SUB + RTYPE(MTYPE_M8I1) + DESC(MTYPE_V),
  OPC_M8I2SUB            = OPR_SUB + RTYPE(MTYPE_M8I2) + DESC(MTYPE_V),
  OPC_M8I4SUB            = OPR_SUB + RTYPE(MTYPE_M8I4) + DESC(MTYPE_V),
  OPC_M8F4SUB            = OPR_SUB + RTYPE(MTYPE_M8F4) + DESC(MTYPE_V),
#endif /* TARG_X8664 */
...
#ifdef FLOAT_ROUNDING_OPCODES
  OPC_F4F4TRUNC          = OPR_TRUNC + RTYPE(MTYPE_F4) + DESC(MTYPE_F4),
  OPC_F8F8TRUNC          = OPR_TRUNC + RTYPE(MTYPE_F8) + DESC(MTYPE_F8),
#endif
#ifndef TARG_X8664
...
#if defined(TARG_SL)  //fork_joint
  OPC_SL2_FORK_MAJOR = OPR_SL2_FORK_MAJOR + RTYPE(MTYPE_V) + DESC(MTYPE_V),
  OPC_SL2_FORK_MINOR = OPR_SL2_FORK_MINOR + RTYPE(MTYPE_V) + DESC(MTYPE_V),
#endif 
