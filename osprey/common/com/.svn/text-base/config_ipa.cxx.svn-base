...
#ifdef W2C
BOOL IPA_Enable_Align_Analysis = FALSE; /*enable ipa align analysis*/                                 
BOOL IPA_Enable_Allocate_Simplify = FALSE; /* enable F90 allocate array simplification */      
#endif
...
#ifdef PACE
/* ===== Feature enable flags: ===== */
BOOL IPA_Enable_Normal = TRUE; /* enable normal IPA*/
BOOL IPA_Enable_AGGR = FALSE;      /* enable aggressive IPA*/
BOOL IPA_Enable_Slicing = FALSE; 	/* enable IPA scc slicing */
#endif
...
#endif // KEY
#ifdef PACE
    { OVK_BOOL, OV_VISIBLE,	FALSE, "aggr_opt",	"",
	  0, 0, 0, &IPA_Enable_AGGR, NULL,
	  "Enable IPA aggressive optimizations"},
    { OVK_BOOL, OV_VISIBLE,	FALSE, "scc_slicing", "",
    	  0, 0, 0, &IPA_Enable_Slicing, NULL,
    	  "Enable IPA SCC Slicing"},
#endif
