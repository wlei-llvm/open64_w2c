...
#ifdef W2C
  Elf64_Word _align_info_offset, _access_array_offset, _access_vector_offset;
  Elf64_Word _intsymb_node_offset, _sumprod_node_offset; 
#endif
...
#ifdef W2C
  // actual array ref points align information
  mINT32 _align_info_size, _access_array_size, _access_vector_size;
  mINT32 _intsymb_node_size, _sumprod_node_size; 
#endif
  // size of each entry
...
#ifdef W2C
  // actual array ref points align information
  mINT32 _align_info_entry_size, _access_array_entry_size, _access_vector_entry_size;
  mINT32 _intsymb_node_entry_size, _sumprod_node_entry_size;                                       // cmchen 08-3-8: 194-196
...
#ifdef W2C
  // actual array ref points align information
  void Set_align_info_offset(Elf64_Word s) { _align_info_offset = s; }
  void Set_access_array_offset(Elf64_Word s) { _access_array_offset = s; }
  void Set_access_vector_offset(Elf64_Word s) { _access_vector_offset = s; }
  void Set_intsymb_node_offset(Elf64_Word s) { _intsymb_node_offset = s; }
  void Set_sumprod_node_offset(Elf64_Word s) { _sumprod_node_offset = s; }
  // end of align info     
#endif
...
#ifdef W2C
  // actual array ref points align information
  void Set_align_info_size(mINT32 s) { _align_info_size = s; }
  void Set_access_array_size(mINT32 s) { _access_array_size = s; }
  void Set_access_vector_size(mINT32 s) { _access_vector_size = s; }
  void Set_intsymb_node_size(mINT32 s) { _intsymb_node_size = s; }
  void Set_sumprod_node_size(mINT32 s) { _sumprod_node_size = s; }
#endif
...
#ifdef W2C
  // actual array ref points align information
  void Set_align_info_entry_size(mINT32 s) { _align_info_entry_size = s; }
  void Set_access_array_entry_size(mINT32 s) { _access_array_entry_size = s; }
  void Set_access_vector_entry_size(mINT32 s) { _access_vector_entry_size = s; }
  void Set_intsymb_node_entry_size(mINT32 s) { _intsymb_node_entry_size = s; }
  void Set_sumprod_node_entry_size(mINT32 s) { _sumprod_node_entry_size = s; }
#endif
...
#ifdef W2C
  // actual array ref points align information
  Elf64_Word Get_align_info_offset() { return _align_info_offset; }
  Elf64_Word Get_access_array_offset() { return _access_array_offset; }
  Elf64_Word Get_access_vector_offset() { return _access_vector_offset; }
  Elf64_Word Get_intsymb_node_offset() { return _intsymb_node_offset; }
  Elf64_Word Get_sumprod_node_offset() { return _sumprod_node_offset; }
#endif
...
#ifdef W2C
  mINT32 Get_align_info_size() { return _align_info_size; }
  mINT32 Get_access_array_size() { return _access_array_size; }
  mINT32 Get_access_vector_size() { return _access_vector_size; }
  mINT32 Get_intsymb_node_size() { return _intsymb_node_size; }
  mINT32 Get_sumprod_node_size() { return _sumprod_node_size; }
#endif
...
#ifdef W2C
    mINT32 _actual_align_index; //_m; index into actual_align_info in ARRAY_ALIGN_SUMMARY
    mINT32 _access_array_index; //_m; index into actual_access_array in ARRAY_ALIGN_SUMMARY
#endif
public:
...
#ifdef W2C
    void Set_align_index(INT32 idx)     { _actual_align_index = idx; }
    INT32 Get_align_index() const       { return _actual_align_index; }
    void Set_array_index(INT32 idx)     { _access_array_index = idx; }
    INT32 Get_array_index() const       { return _access_array_index; }
#endif
